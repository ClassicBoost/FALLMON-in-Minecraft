...
# data
# default stats
attribute @p minecraft:movement_speed base set 0.11
attribute @p minecraft:armor base set 1
attribute @p minecraft:max_health base set 20
attribute @p minecraft:attack_damage base set 5
...
title @p actionbar {"text": "You are playing as Shinx", "color": "#47FF47"}
...
tellraw @p {"text": "You have chosen Shinx", "color" : "#47FF47", "bold": true}
