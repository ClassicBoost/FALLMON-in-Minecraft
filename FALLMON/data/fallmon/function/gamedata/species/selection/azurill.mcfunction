...
# data
# default stats
attribute @p minecraft:movement_speed base set 0.13
...
title @p actionbar {"text": "You are playing as Azurill", "color": "#47FF47"}
