...
execute at @e[type=zombie] as @a[distance=..2] run playsound fallmon.radbad neutral @s[scores={unchippedMode=0}] ~ ~ ~ 1 1 1
execute at @e[type=husk] as @a[distance=..2] run scoreboard players add @p radiation 10
execute at @e[type=husk] as @a[distance=..2] run playsound fallmon.radbad neutral @s[scores={unchippedMode=0}] ~ ~ ~ 1 1 1
