effect give @a[gamemode=!creative,gamemode=!spectator,scores={radiation=..49,survivalMode=0,hunger=11..}] regeneration 2 1 true
effect give @a[gamemode=!creative,gamemode=!spectator,scores={radiation=..599,survivalMode=1,hunger=19..}] regeneration 2 1 true
