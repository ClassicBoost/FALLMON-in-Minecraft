...
title @p actionbar {"text": "You are playing as Buneary", "color": "#47FF47"}
...
tellraw @p {"text": "You have chosen Buneary", "color" : "#47FF47", "bold": true}
...
playsound entity.rabbit.ambient master @a ~ ~ ~ 1000 0