...
title @p actionbar {"text": "You are playing as Pachirisu", "color": "#47FF47"}
...
tellraw @p {"text": "You have chosen Pachirisu", "color" : "#47FF47", "bold": true}
tellraw @p {"text": "Speed: x0.9", "color" : "#47FF47"}
tellraw @p {"text": "Natural Armor: 3", "color" : "#47FF47"}
