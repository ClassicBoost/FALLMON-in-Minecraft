...
title @p actionbar {"text": "You are playing as Elekid", "color": "#47FF47"}
...
tellraw @p {"text": "You have chosen Elekid", "color" : "#47FF47", "bold": true}
tellraw @p {"text": "Speed: x1.7", "color" : "#47FF47"}
