...
title @p actionbar {"text": "You are playing as Totodile", "color": "#47FF47"}
...
tellraw @p {"text": "You have chosen Totodile", "color" : "#47FF47", "bold": true}
...
tellraw @p {"text": "Knockback: 2", "color" : "#47FF47"}
