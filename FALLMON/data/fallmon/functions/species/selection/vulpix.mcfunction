...
title @p actionbar {"text": "You are playing as Vulpix", "color": "#47FF47"}
...
tellraw @p {"text": "You have chosen Vulpix", "color" : "#47FF47", "bold": true}
...
playsound entity.fox.ambient master @a ~ ~ ~ 1000 0