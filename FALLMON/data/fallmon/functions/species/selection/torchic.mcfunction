...
title @p actionbar {"text": "You are playing as Torchic", "color": "#47FF47"}
...
tellraw @p {"text": "You have chosen Torchic", "color" : "#47FF47", "bold": true}
...
playsound entity.chicken.ambient master @a ~ ~ ~ 1000 2