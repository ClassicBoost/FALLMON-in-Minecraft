execute if entity @a[team=!] run effect clear @p haste
execute if entity @a[team=!] run effect clear @p water_breathing
execute if entity @a[team=!] run effect clear @p jump_boost
execute if entity @a[team=!] run effect clear @p fire_resistance
...
effect give @a[team=snivy] fire_resistance infinite 0 true
...
execute if entity @a[team=squirtle] run effect give @a[team=snivy] water_breathing infinite 0 true
...
effect give @a[team=snivy] jump_boost infinite 1 true
...
effect give @a[team=snivy] haste infinite 0 true
