...
effect give @a[team=charmander] fire_resistance 2 0 true
...
effect give @a[team=squirtle] water_breathing 2 0 true
...
effect give @a[team=torchic] fire_resistance 2 1 true
...
effect give @a[team=mudkip] water_breathing 2 1 true
...
effect give @a[team=volpix] water_breathing 2 1 true
...
effect give @a[team=chimchar] fire_resistance 2 1 true

# piplup
# bf as piplup??????????
execute as @a[team=piplup] run attribute @s[team=piplup] generic.attack_damage base set 3
effect give @a[team=piplup] water_breathing 2 1 true
...
effect give @a[team=growlithe] fire_resistance 2 1 true
...
effect give @a[team=tepig] fire_resistance 2 0 true
...
effect give @a[team=oshawott] water_breathing 2 0 true
...
effect give @a[team=froakie] water_breathing 2 0 true
